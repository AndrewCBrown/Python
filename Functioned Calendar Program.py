...
def greeting():
    ...
    print ("Year input should be between 1800 and 2099")
    print ("Month input should be fully spelled out and capitalized")

#Define Valid Years Function
def validYears():
    valid_years=[]
    x=1799
    while x<2099:
...
#Define Printing the Calendar
def print_calendar(value, days, month, year):
...
def main():
    ...
    print_calendar(value, days, month, year)
